...
import com.koi.projectlib.databinding.ActivityUploadFileBinding
 ...
 * 实现文件上传功能
 * */
class UploadFileActivity : EngineActivity<ActivityUploadFileBinding>(R.layout.activity_upload_file) {
