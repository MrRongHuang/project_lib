...
import com.koi.highlightpro.util.calculateHighLightViewRect
import com.koi.highlightpro.util.dp
import com.koi.highlightpro.util.isAttachToWindow
import com.koi.highlightpro.view.MaskContainer
...
//            if (it.setOnlyButtonClick) {
//                if (it.nextTipsView == null) {
//                    it.nextTipsView = rootView.findViewById(it.nextTipsViewId)
//                    it.nextTipsView?.setOnClickListener(onClickListener)
//                    maskContainer.setOnClickListener(null)
//                }
//            } else {
//                if (it.nextTipsView == null) {
//                    it.nextTipsView = rootView.findViewById(it.nextTipsViewId)
//                    it.nextTipsView?.setOnClickListener(null)
//                    maskContainer.setOnClickListener(onClickListener)
//                }
//            }
//        }
    ...
    private fun showNextHighLightView() {
        ...
        if (hasHighLightView().not()) {
            ...
            highlightParameters[0].forEach {
                ...
                if (it.setOnlyButtonClick) {
                    if (it.nextTipsView == null) {
                        it.nextTipsView = it.tipsView?.findViewById(it.nextTipsViewId)
                        maskContainer.setOnClickListener(null)
                        it.nextTipsView?.setOnClickListener(onClickListener)
                    }
                } else {
    ...
    private fun checkNextTipViewIdIsValid(parameter: HighlightParameter): Boolean =
        parameter.nextTipsViewId != -1
