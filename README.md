...
```groovy
dependencies {		
	implementation 'com.github.MrRongHuang:project_lib:v1.0.01'
}
```
...
##### 关于  [HighlightParameter.Builder](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/parameter/HighlightParameter.kt)
...
##### 关于 [HighlightShape](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/shape/HighlightShape.kt)

| HighlightShape                                               | 方法描述           |
| ------------------------------------------------------------ | ------------------ |
| [RectShape](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/shape/RectShape.kt) | 边缘模糊的矩形图形 |
| [CircleShape](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/shape/CircleShape.kt) | 边缘模糊的圆形     |
| [OvalShape](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/shape/OvalShape.kt) | 边缘模糊的椭圆形   |

**注意**

任何形状都是基于高亮view在屏幕中的矩形区域，我们可以通过**setHighlightVerticalPadding** 或 **setHighlightHorizontalPadding**来扩大高亮区域

##### 关于 [Constraints](https://github.com/MrRongHuang/project_lib/blob/master/highlight_pro/src/main/java/com/koi/highlightpro/parameter/Constraints.kt)
...
上面我们基本把[HighlightPro](https://github.com/MrRongHuang/project_lib/tree/master/highlight_pro)的用法介绍完了，欢迎大家使用，如果它对您有帮助，给个star呗。如果你有更好的建议或思路，欢迎提交pull request。
